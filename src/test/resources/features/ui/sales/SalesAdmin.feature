...
Feature: Sales Management Functionality
  ...
  Scenario: Verify plant dropdown loads only available plants with stock
    Given the user navigates to the "sales" page via sidebar
  ...
  Scenario: Verify sell plant quantity validation for negative values
    Given the user navigates to the "sales" page via sidebar
    And the admin navigates to the Sell Plant page
  ...
  Scenario: Verify validation for empty plant selection
    Given the user navigates to the "sales" page via sidebar
    And the admin navigates to the Sell Plant page
  ...
  Scenario: Verify quantity validation against available stock
    Given the user navigates to the "sales" page via sidebar
    And the admin navigates to the Sell Plant page
    ...
    And the admin deletes the created sales record